...
sudo aptitude -y install dnsutils tree tcpdump zip unzip traceroute xml-twig-tools libdbus-glib-1-2 libx11-xcb1 libxt6 libxml2-dev libxslt1-dev libncurses-dev openssh-server jq
